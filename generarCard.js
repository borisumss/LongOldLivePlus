...
var addCols = function () {
    for (var i = 1; i <= num; i++) {
        var myPanel = $(`<a href="#!" data-bs-toggle="modal" data-bs-target="#modal2"> 
                            <div type="button" class="card mb-3 mx-auto w-100mb-4 rounded" style="max-width: 540px;" href="#"> 
                                <div class="row g-0 justify-content-center align-items-center">
                                    <div class="col-md-4 ">
                                        <img src="images/logo.jpg" class="img-fluid rounded-start" alt="..."style="max-width: 150px;max-height: 150px;">
                                    </div>
                                    <div class="col-md-8">
                                        <div class="card-body">
                            ...
                            <div class="modal-dialog modal-lg modal-dialog-centered">
                                <div class="modal-content">
                                    <div class="card mx-auto">
                                        <img src="images/logo.jpg" class="card-img-top mx-auto" style="max-width: 400px; max-width: 400px;" alt="...">
                                        <div class="card-body">
